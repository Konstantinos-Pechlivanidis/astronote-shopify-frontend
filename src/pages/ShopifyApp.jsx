  ...
  const extensionFeatures = [
    {
      ...
      description: 'Access Astronote directly from your Shopify admin. No need to switch between apps—manage everything in one place.',
  ...
  const quickStart = [
    {
      ...
      description: 'Click the button above to access your full Astronote dashboard in a new browser tab.',
    },
    {
      step: '2',
    ...
    },
    {
      ...
      description: 'Customers opt-in directly from your store. Phone numbers sync automatically to your Astronote dashboard.',
    },
    {
      step: '4',
      title: 'Send & Automate',
      description: 'Create campaigns, set up automations, and watch your sales grow. All from your Astronote dashboard.',
    },
  ];
          ...
          <div className="relative max-w-[1200px] mx-auto">
            <div className="text-center mb-16">
              ...
              <h1 className="text-hero md:text-7xl font-bold mb-6 leading-tight">
                ...
                <GradientText>Astronote SMS Marketing</GradientText>
              </h1>
              ...
              <div className="flex justify-center items-center">
                <GlassButton
                  onClick={() => {
                    window.open(`${FRONTEND_URL}/shopify`, '_blank', 'noopener,noreferrer');
                  }}
                  variant="primary"
                  size="lg"
                ...
                >
                  ...
                  Open Astronote Dashboard in New Tab
                </GlassButton>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 px-4 lg:px-8 bg-surface-dark/50">
          <div className="max-w-[1200px] mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-border-subtle max-w-2xl mx-auto">
                Choose a subscription plan that fits your needs. All plans include full access to all features.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <GlassButton
                      ...
                      className="w-full"
                      onClick={() => {
                        window.open(`${FRONTEND_URL}/shopify/app/billing`, '_blank', 'noopener,noreferrer');
                      }}
                    >
            ...
            <GlassCard variant="ice" className="p-6">
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-xl bg-ice-accent/20 flex-shrink-0">
                  <Icon name="info" size="xl" variant="ice" />
                </div>
                <div>
                  <h3 className="text-lg font-bold mb-2">Additional Credits</h3>
                  <p className="text-sm text-border-subtle">
                    Need more credits? Purchase additional SMS credits at any time. Credits never expire and can be used alongside your subscription free credits.
                  </p>
                </div>
              </div>
            </GlassCard>
