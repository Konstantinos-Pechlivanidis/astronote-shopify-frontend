  ...
  const contactMethods = [
    {
      ...
      contact: 'support@astronote.com',
      action: 'mailto:support@astronote.com?subject=Astronote Support Request',
      badge: '24/7',
      color: 'ice',
    },
    {
      icon: 'schedule',
      title: 'Book a Demo',
      description: 'Schedule a personalized demo to see how Astronote can grow your business',
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-border-subtle max-w-2xl mx-auto">
              Have questions about Astronote? We're here to help. Reach out and we'll get back to you within 24 hours.
            </p>
          </div>
            ...
            <div>
              ...
              <GlassCard variant="dark" className="p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-h3 font-semibold mb-1">Astronote HQ</h3>
                    <p className="text-sm text-border-subtle">
