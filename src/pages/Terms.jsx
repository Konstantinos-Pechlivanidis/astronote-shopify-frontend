          ...
          <GlassCard className="p-8 md:p-12 space-y-8">
            <section>
              ...
              <p className="text-body text-border-subtle leading-relaxed mb-4">
                By accessing or using Astronote's SMS marketing platform ("Service"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, you may not access the Service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-body text-border-subtle leading-relaxed mb-4">
                Astronote provides an SMS marketing platform that integrates with Shopify stores, allowing merchants to send marketing messages, transactional notifications, and automated campaigns to their customers via SMS.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-4 p-4 bg-ice-accent/10 rounded-lg">
                <p className="text-body text-border-subtle">
                  <strong>Email:</strong> <a href="mailto:legal@astronote.com" className="text-ice-accent hover:underline">legal@astronote.com</a>
                </p>
