      ...
      <div className="min-h-screen pt-4 sm:pt-6 pb-12 sm:pb-16 px-4 sm:px-6 lg:px-8 bg-neutral-bg-base w-full max-w-full">
        <div className="max-w-[1400px] mx-auto w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 lg:gap-6">
            <GlassCard 
              variant="ice" 
              className="p-5 sm:p-6 group hover:scale-[1.02] hover:shadow-glass-light-lg transition-all duration-200 cursor-pointer focus-ring" 
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="p-3 sm:p-4 rounded-xl bg-ice-soft/80 group-hover:bg-ice-primary/20 transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs sm:text-sm text-primary">Start a new SMS campaign</p>
                </div>
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs sm:text-sm text-primary">View and manage your contacts</p>
                </div>
                <Icon name="arrowRight" size="sm" variant="ice" className="opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </GlassCard>
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs sm:text-sm text-primary">Set up automated workflows</p>
                </div>
                <Icon name="arrowRight" size="sm" variant="ice" className="opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </GlassCard>
