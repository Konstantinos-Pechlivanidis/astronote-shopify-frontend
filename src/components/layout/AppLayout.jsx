...
export default function AppLayout({ children }) {
  ...
  const navItems = [
    ...
    { path: `${basePath}/campaigns`, label: 'Campaigns', icon: 'campaign' },
    { path: `${basePath}/contacts`, label: 'Contacts', icon: 'segment' },
    { path: `${basePath}/automations`, label: 'Automations', icon: 'automation' },
    { path: `${basePath}/templates`, label: 'Templates', icon: 'template' },
    { path: `${basePath}/reports`, label: 'Reports', icon: 'report' },
    { path: `${basePath}/billing`, label: 'Billing', icon: 'sms' },
    { path: `${basePath}/settings`, label: 'Settings', icon: 'integration' },
  ];
      ...
      <aside className="hidden lg:flex lg:flex-col lg:w-72 lg:fixed lg:inset-y-0 lg:left-0 lg:z-30">
        <div className="flex-1 flex flex-col bg-neutral-surface-primary backdrop-blur-[30px] -webkit-backdrop-blur-[30px] border-r border-neutral-border/40 shadow-glass-light-lg">
          ...
          <div className="flex items-center gap-3 px-6 py-6 border-b border-neutral-border/40 bg-gradient-to-r from-neutral-surface-primary to-neutral-surface-secondary/30">
            ...
            />
            <span className="text-xl font-bold text-neutral-text-primary tracking-tight">Astronote</span>
          </div>
