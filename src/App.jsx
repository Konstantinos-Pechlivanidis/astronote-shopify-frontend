    ...
    <>
      ...
      <Suspense fallback={<Loading />}>
        <div className="page-enter">
          ...
          />
          <Route
            path="/shopify/app/campaigns/new"
            element={
              <ProtectedRoute>
                <AppLayout>
                  <CampaignCreate />
          ...
          />
          <Route
            path="/shopify/app/campaigns/:id/edit"
            element={
              <ProtectedRoute>
                <AppLayout>
                  <CampaignCreate />
          ...
          />
          <Route
            path="/shopify/app/contacts/:id/edit"
            element={
              <ProtectedRoute>
                <AppLayout>
                  <ContactDetail />
          ...
          />
          <Route
            path="/shopify/app/automations/new"
            element={
              <ProtectedRoute>
                <AppLayout>
                  <AutomationForm />
          ...
          />
          <Route
            path="/shopify/app/automations/:id"
            element={
              <ProtectedRoute>
                <AppLayout>
                  <AutomationForm />
