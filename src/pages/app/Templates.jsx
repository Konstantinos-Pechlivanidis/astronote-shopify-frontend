              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                {templates.map((template) => (
                  ...
                  >
                    ...
                    {/* Content Preview */}
                    <p className="text-sm text-primary line-clamp-3 mb-4 flex-grow">
                      {template.content}
                    </p>
                    ...
                    {template.tags && Array.isArray(template.tags) && template.tags.length > 0 && (
                      <div className="flex flex-wrap gap-1.5 mb-4">
                        {template.tags.slice(0, 3).map((tag, idx) => (
                          <span
                            key={idx}
                            className="px-2 py-0.5 text-xs rounded-full bg-neutral-surface-secondary/50 border border-neutral-border/30 text-primary"
                          >
                            {tag}
                          </span>
                        ))}
