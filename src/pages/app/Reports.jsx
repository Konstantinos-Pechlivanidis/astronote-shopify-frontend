...
export default function Reports() {
  ...
  return (
    <>
      <SEO
        title="Reports - Astronote SMS Marketing"
        description="View analytics and performance reports"
        path="/shopify/app/reports"
      />
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
                    <GlassCard variant="ice" className="p-5 hover:shadow-glass-light-lg transition-shadow">
                      ...
                      <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Messages Sent</p>
                    </GlassCard>
                    ...
                    <GlassCard className="p-5 hover:shadow-glass-light-lg transition-shadow">
                      ...
                      <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Delivery Rate</p>
                    </GlassCard>
                    ...
                    <GlassCard className="p-5 hover:shadow-glass-light-lg transition-shadow">
                      ...
                      <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Campaigns</p>
                    </GlassCard>
                    ...
                    <GlassCard className="p-5 hover:shadow-glass-light-lg transition-shadow">
                      ...
                      <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Contacts</p>
                    </GlassCard>
                    ...
                    <GlassCard variant="fuchsia" className="p-5 hover:shadow-glass-light-lg transition-shadow">
                      ...
                      <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Credits</p>
                    </GlassCard>
                  </div>
                  ...
                  {campaigns.campaignStats && (
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                      <GlassCard className="p-5">
                        ...
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Total Sent</p>
                      </GlassCard>
                      <GlassCard className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-ice-primary mb-1">
                          {(campaigns.campaignStats.totalDelivered || 0).toLocaleString()}
                        </p>
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Delivered</p>
                      </GlassCard>
                      <GlassCard className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-red-500 mb-1">
                          {(campaigns.campaignStats.totalFailed || 0).toLocaleString()}
                        </p>
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Failed</p>
                      </GlassCard>
                      <GlassCard className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-neutral-text-primary mb-1">
                        ...
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Avg Delivery Rate</p>
                      </GlassCard>
                    </div>
                  )}
                ...
                <div className="space-y-6 sm:space-y-8">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                    <GlassCard className="p-5">
                      ...
                      <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Total Messages</p>
                    </GlassCard>
                    {messaging.byDirection && (
                      <>
                        <GlassCard className="p-5">
                          ...
                          <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Outbound</p>
                        </GlassCard>
                        <GlassCard className="p-5">
                          <p className="text-2xl sm:text-3xl font-bold text-neutral-text-primary mb-1">
                            {(messaging.byDirection.inbound || 0).toLocaleString()}
                          </p>
                          <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Inbound</p>
                        </GlassCard>
                      </>
                    )}
                    {messaging.byStatus && (
                  ...
                  {credits.summary && (
                    <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 sm:gap-4">
                      <GlassCard className="p-5">
                        ...
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Total Credits</p>
                      </GlassCard>
                      <GlassCard className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-fuchsia-primary mb-1">
                          {(credits.summary.usedCredits || 0).toLocaleString()}
                        </p>
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Used</p>
                      </GlassCard>
                      <GlassCard variant="ice" className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-ice-primary mb-1">
                          {(credits.summary.remainingCredits || 0).toLocaleString()}
                        </p>
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Remaining</p>
                      </GlassCard>
                      <GlassCard className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-neutral-text-primary mb-1">
                          {(credits.summary.avgDailyUsage || 0).toLocaleString()}
                        </p>
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Avg Daily</p>
                      </GlassCard>
                      <GlassCard className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-neutral-text-primary mb-1">
                          {(credits.summary.totalPurchases || 0).toLocaleString()}
                        </p>
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Purchases</p>
                      </GlassCard>
                    </div>
                  )}
                  ...
                  {contacts.summary && (
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                      <GlassCard className="p-5">
                        ...
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Total Contacts</p>
                      </GlassCard>
                      <GlassCard variant="ice" className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-ice-primary mb-1">
                          {(contacts.summary.optedInContacts || 0).toLocaleString()}
                        </p>
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Opted In</p>
                      </GlassCard>
                      <GlassCard className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-neutral-text-primary mb-1">
                        ...
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Consent Rate</p>
                      </GlassCard>
                      <GlassCard className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-neutral-text-primary mb-1">
                          {(contacts.summary.recentContacts || 0).toLocaleString()}
                        </p>
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Recent (30d)</p>
                      </GlassCard>
                    </div>
                  )}
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                      {contacts.summary.birthdayContacts !== undefined && (
                        <GlassCard className="p-5">
                          ...
                          <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">With Birthday</p>
                        </GlassCard>
                      )}
                      {contacts.summary.engagedContacts !== undefined && (
                        <GlassCard className="p-5">
                          ...
                          <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Engaged</p>
                        </GlassCard>
                      )}
                      {contacts.summary.engagementRate !== undefined && (
                        <GlassCard className="p-5">
                          ...
                          <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Engagement Rate</p>
                        </GlassCard>
                      )}
                    </div>
                  )}
                  ...
                  {automations.summary && (
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                      <GlassCard className="p-5">
                        ...
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Total Triggered</p>
                      </GlassCard>
                      <GlassCard variant="ice" className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-ice-primary mb-1">
                          {(automations.summary.totalActive || 0).toLocaleString()}
                        </p>
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Active</p>
                      </GlassCard>
                      <GlassCard className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-neutral-text-primary mb-1">
                          {(automations.summary.totalInactive || 0).toLocaleString()}
                        </p>
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Inactive</p>
                      </GlassCard>
                      <GlassCard className="p-5">
                        <p className="text-2xl sm:text-3xl font-bold text-ice-primary mb-1">
                        ...
                        <p className="text-xs sm:text-sm font-medium text-primary uppercase tracking-wider">Completion Rate</p>
                      </GlassCard>
                    </div>
                  )}
                          ...
                          <GlassTableBody>
                            {automations.activeAutomations.map((automation) => (
                              <GlassTableRow key={automation.id}>
                                ...
                                <GlassTableCell>
                                  <span className="text-sm text-primary">{automation.triggerEvent}</span>
                                </GlassTableCell>
                                <GlassTableCell>
                                  <span className={`text-sm ${automation.isActive ? 'text-ice-primary' : 'text-primary'}`}>
