...
const getFrontendUrlInternal = () => {
  if (_frontendUrl === null) {
    ...
    if (import.meta.env.VITE_FRONT_END_URL) {
      ...
      _frontendUrl = 'https://astronote-shopify-frontend.onrender.com';
    }
  }
  return _frontendUrl;
};
...
const getApiUrl = () => {
  ...
  if (typeof window !== 'undefined' && window.location) {
    ...
    if (hostname === frontendHostname) {
      ...
      // Default backend URL
      return 'https://astronote-shopify-backend.onrender.com';
    }
...
export const TOKEN_KEY = 'astronote_app_token';
export const STORE_KEY = 'astronote_store_info';
