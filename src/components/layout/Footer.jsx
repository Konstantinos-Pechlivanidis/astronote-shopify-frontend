      ...
      <div className="max-w-[1200px] mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-border-subtle max-w-xs">
          ...
          <div className="grid grid-cols-3 gap-8">
            <div>
              <h3 className="text-sm font-semibold text-primary-light mb-4">Product</h3>
              <ul className="space-y-2">
                {footerLinks.product.map((link) => (
                  <li key={link.path}>
                    <Link
                      to={link.path}
                      className="text-sm text-border-subtle hover:text-ice-accent transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
            ...
            <div>
              <h3 className="text-sm font-semibold text-primary-light mb-4">Company</h3>
              <ul className="space-y-2">
            ...
            <div>
              <h3 className="text-sm font-semibold text-primary-light mb-4">Legal</h3>
              <ul className="space-y-2">
          ...
          {/* <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 rounded-lg glass flex items-center justify-center hover:bg-ice-accent/20 transition-colors"
                aria-label="Twitter"
              >
