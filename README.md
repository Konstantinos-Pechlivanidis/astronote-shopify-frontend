...
Modern React application for Astronote SMS Marketing App with glass morphism design system.
...
```env
VITE_API_URL=https://astronote-shopify-backend.onrender.com
```
...
### Shopify App Routes
- `/shopify` - Shopify app entry point
- `/shopify/login` - Shopify login page
- `/shopify/auth/callback` - OAuth callback
- `/shopify/app/dashboard` - Dashboard
- `/shopify/app/campaigns` - Campaigns list
- `/shopify/app/campaigns/new` - Create campaign
- `/shopify/app/contacts` - Contacts management
- `/shopify/app/automations` - Automations
- `/shopify/app/templates` - Templates
- `/shopify/app/reports` - Reports
- `/shopify/app/billing` - Billing
- `/shopify/app/settings` - Settings
...
```env
VITE_API_URL=https://astronote-shopify-backend.onrender.com
VITE_FRONTEND_URL=https://astronote-shopify-frontend.onrender.com
```
...
- Repository: https://github.com/Konstantinos-Pechlivanidis/astronote-shopify-frontend
- Production URL: https://astronote-shopify-frontend.onrender.com
